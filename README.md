...
|:-:|:---|:---:|:---:|
| 01 | **Tensor operations & AutoDiff**<br>テンソル演算・自動微分<br>텐서 연산, 자동미분 | [View](https://github.com/twen2ty5five-boop/ASMR/blob/main/contents/tensorflow/01_basic_operations/main.py) | [![Open in github.dev](https://img.shields.io/badge/Open_in-github.dev-0A0A0A?logo=visualstudiocode&logoColor=white)](https://github.dev/twen2ty5five-boop/ASMR/blob/main/contents/tensorflow/01_basic_operations/main.py) |
| 02 | **Basic Linear Regression**<br>基本的な線形回帰<br>기본 선형회귀 구현 | [View](https://github.com/twen2ty5five-boop/ASMR/blob/main/contents/tensorflow/02_linear_regression/main.py) | [![Open in github.dev](https://img.shields.io/badge/Open_in-github.dev-0A0A0A?logo=visualstudiocode&logoColor=white)](https://github.dev/twen2ty5five-boop/ASMR/blob/main/contents/tensorflow/02_linear_regression/main.py) |
| 03 | **MLP Classification**<br>MLP分類モデル<br>MLP 분류 모델 | [View](https://github.com/twen2ty5five-boop/ASMR/blob/main/contents/tensorflow/03_classification_mlp/main.py) | [![Open in github.dev](https://img.shields.io/badge/Open_in-github.dev-0A0A0A?logo=visualstudiocode&logoColor=white)](https://github.dev/twen2ty5five-boop/ASMR/blob/main/contents/tensorflow/03_classification_mlp/main.py) |
| 04 | **CNN Image Classification**<br>CNN画像分類<br>CNN 이미지 분류 | [View](https://github.com/twen2ty5five-boop/ASMR/blob/main/contents/tensorflow/04_cnn_mnist/main.py) | [![Open in github.dev](https://img.shields.io/badge/Open_in-github.dev-0A0A0A?logo=visualstudiocode&logoColor=white)](https://github.dev/twen2ty5five-boop/ASMR/blob/main/contents/tensorflow/04_cnn_mnist/main.py) |
| 05 | **tf.data Pipeline**<br>tf.data パイプライン例<br>tf.data 파이프라인 예제 | [View](https://github.com/twen2ty5five-boop/ASMR/blob/main/contents/tensorflow/05_data_pipeline/main.py) | [![Open in github.dev](https://img.shields.io/badge/Open_in-github.dev-0A0A0A?logo=visualstudiocode&logoColor=white)](https://github.dev/twen2ty5five-boop/ASMR/blob/main/contents/tensorflow/05_data_pipeline/main.py) |
...
| 07 | **Full Pipeline Example**<br>総合パイプライン例<br>종합 파이프라인 예제 | [View](https://github.com/twen2ty5five-boop/ASMR/blob/main/contents/tensorflow/baiscs_and_pipelines/main.py) | [![Open in github.dev](https://img.shields.io/badge/Open_in-github.dev-0A0A0A?logo=visualstudiocode&logoColor=white)](https://github.dev/twen2ty5five-boop/ASMR/blob/main/contents/tensorflow/baiscs_and_pipelines/main.py) |
